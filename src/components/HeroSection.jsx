...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/4 w-[30rem] h-[30rem] bg-gradient-radial from-accent/10 to-transparent rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[30rem] h-[30rem] bg-gradient-radial from-accent/5 to-transparent rounded-full blur-3xl pointer-events-none" />

      <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          {/* Left side - Text content */}
          <motion.div
            className="flex flex-col gap-6 md:col-span-8 lg:col-span-7"
          ...
          >
            ...
            <motion.div
              variants={fadeInUp}
              className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-accent/20 bg-accent/5 backdrop-blur-md shadow-[0_0_20px_rgba(255,107,0,0.15)] w-fit mb-2"
            >
            ...
            <motion.h1
              className="text-6xl sm:text-7xl md:text-8xl lg:text-[7.5rem] font-black tracking-tighter uppercase leading-[0.9] text-white"
              variants={fadeInUp}
            ...
            <motion.div
              className="text-2xl md:text-3xl font-semibold h-12 font-mono flex items-center gap-1"
              variants={fadeInUp}
              transition={{ delay: 0.3 }}
            >
              <NeonText color="orange">{displayText}</NeonText>
              <motion.span
                className="text-accent text-3xl font-light leading-none"
                animate={{ opacity: [1, 0] }}
            ...
            {/* Description */}
            <motion.p
              className="text-base sm:text-lg text-white/70 leading-relaxed max-w-xl font-light"
              variants={fadeInUp}
            ...
            >
              {[
                ...
                <motion.a
                  ...
                  className="w-10 h-10 rounded-lg border border-white/10 flex items-center justify-center text-white/60 hover:text-white hover:border-accent hover:shadow-[0_0_15px_rgba(255,107,0,0.25)] transition-all duration-300"
          ...
          {/* Right side - profile placeholder or spacing to clear 3D Canvas elements */}
