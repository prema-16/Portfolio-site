...
const ProjectsSection = () => {
  ...
  const projects = [
    ...
    {
      id: 3,
      title: 'QuickStay – Property Rental App',
      category: 'fullstack',
      image: '🏡',
      description: 'Full-stack Airbnb-inspired web app for browsing, creating, editing, and reviewing property listings with secure auth.',
      tech: ['Node.js', 'Express.js', 'MongoDB', 'Mongoose', 'EJS', 'Bootstrap', 'Passport.js'],
      github: 'https://github.com/prema-16/QuickStay',
      live: 'https://quickstay-mk8g.onrender.com',
      details: 'Built a full-stack Airbnb-inspired web application that allows users to browse, create, edit, and review property listings. Integrated secure authentication, session-based login, image uploads, flash messaging, and MongoDB database operations using Node.js, Express.js, MongoDB, Mongoose, Passport.js, and EJS.',
      stats: 'Full Stack | MVC | Auth: Passport.js',
    },
    {
      id: 4,
      ...
      category: 'frontend',
      image: '🧮',
      description: 'Responsive financial utility web app with GST calculation and loan EMI calculation features built with React & Vite.',
      tech: ['React', 'Vite', 'CSS'],
      github: 'https://github.com/prema-16/GST-EMI-Calculator',
      live: 'https://gst-emi-calculator-six.vercel.app/',
      details: 'Built a responsive financial utility web application with GST calculation and loan EMI calculation features. Implemented GST add/remove logic and EMI calculations using JavaScript formulas. Designed a clean responsive UI using React and CSS. Deployed on Vercel and maintained source code on GitHub.',
      stats: 'Deployed: Vercel | React + Vite',
    },
    {
      id: 5,
      title: 'Weather App',
