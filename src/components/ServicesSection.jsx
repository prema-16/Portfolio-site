  ...
  return (
    <section ref={ref} id="services" className="relative py-32 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute bottom-0 right-0 w-[30rem] h-[30rem] bg-gradient-radial from-accent/5 to-transparent rounded-full blur-3xl pointer-events-none" />
        ...
        >
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <motion.div
                  className="glass p-8 rounded-2xl h-full flex flex-col justify-between border border-white/[0.05] hover:border-accent/20 transition-all duration-300 relative overflow-hidden shadow-xl"
                >
                  ...
                  <div className="relative z-10 flex-1 flex flex-col justify-between">
                    <div>
                      {/* Icon */}
                      <motion.div
                        className="w-12 h-12 rounded-xl bg-accent/10 border border-accent/20 flex items-center justify-center mb-5 group-hover:bg-accent group-hover:text-white transition-all duration-300 text-accent"
        ...
        >
          ...
          <p className="text-white/60 mb-8 max-w-xl mx-auto font-light leading-relaxed">
